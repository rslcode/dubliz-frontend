...
export const StartingSoonAuctionsSection = observer(
    ...
    return (
      ...
      >
        <div className="d-flex align-items-center section-header justify-content-between w-100">
          <h1 className="text-4xl font-bold text-center m-0">{t('starting_soon_auctions.starting_soon_plural')}</h1>
          <Link href="/auctions/starting-soon">
