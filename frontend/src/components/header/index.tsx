...
export const Header = ({mobileMenuOpened, setMobileMenuOpened}: any) => {
                    ...
                    <div className="header-root p-0 m-0 d-flex flex-column">
                        <div className="align-items-center w-100">
                            ...
                            <div className="col-xl-6 col-lg-5 col-md-2 col-sm-2 col-4">
                                <div className="d-flex align-items-center header-content d-none d-xl-flex">
                                    <div className="d-flex align-items-center">
                                        <div className="d-flex align-items-center gap-1">
                                            <div className={`d-flex menu-action-buttons gap-1`}>
                                                <ChatButton/>
                                                <FavouritesButton/>
                                                <NotificationsButton/>
                                            </div>
                                ...
                                <div className="d-flex align-items-center justify-content-end gap-4 sm-none">
